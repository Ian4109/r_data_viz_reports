...
sysfonts::font_add(
  family = "noto_tc",
  regular = "C:/Users/szian/Downloads/Noto_Sans_TC/static/NotoSansTC-Regular.ttf" # path to your font file
)
...
```{r}
income_path <- "C:/Users/szian/OneDrive/文件/GitHub/r_data_viz_reports/data/raw/income_distribution_by_village_2022_newTaipei.csv"
...
```{r}
shp_path <- "C:/Users/szian/OneDrive/文件/GitHub/r_data_viz_reports/data/raw/村(里)界(TWD97經緯度)1141031/VILLAGE_NLSC_11401031.shp"
...
# 3. Paste key below:
register_google(key = "AIzaSyDaVUi9FtqLQZ9-wPtmKOPfgM0YYXTpwFU", write = FALSE)
